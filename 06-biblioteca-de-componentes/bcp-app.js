    ...
    <PaperProvider>
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <Button mode='contained-tonal' onPress={() => alert('Clicou')} >Clicar</Button>
          <Button mode='elevated' onPress={() => alert('Clicou')} >Clicar</Button>
          <Button mode='outlined' onPress={() => alert('Clicou')} >Clicar</Button>
          <Button mode='text' onPress={() => alert('Clicou')} >Clicar</Button>
